...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.actionLoadSettings = QAction(Dialog)
        self.actionLoadSettings.setObjectName(u"actionLoadSettings")
        self.actionLoadSettings.setMenuRole(QAction.MenuRole.NoRole)
        ...
        self.btnLoad.clicked.connect(self.actionLoadSettings.trigger)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.actionLoadSettings.setText(QCoreApplication.translate("Dialog", u"LoadSettings", None))
#if QT_CONFIG(tooltip)
        self.actionLoadSettings.setToolTip(QCoreApplication.translate("Dialog", u"LoadSettings", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.actionLoadSettings.setShortcut(QCoreApplication.translate("Dialog", u"Ctrl+L", None))
#endif // QT_CONFIG(shortcut)
